function focusInput1() {
		document.getElementById("archery").focus();
}
function focusInput2() {
		document.getElementById("football").focus();
}
function focusInput3() {
		document.getElementById("basketball").focus();
}
function focusInput4() {
		document.getElementById("rockclimbing").focus();
}
function focusInput5() {
		document.getElementById("pingpong").focus();
}
function focusInput6() {
		document.getElementById("dance").focus();
}
