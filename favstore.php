...
// $query0= "SELECT store_id FROM likes where customer_id = '$_SESSION[userid]'";
// $result0= mysqli_query($db, $query0) or die ("Couldnt execute query.");
$query = "SELECT name, id from shop, likes where customer_id='$_SESSION[userid]' and shop.id = likes.store_id";
...
echo " <div class='container-login100-form-btn m-t-20'> <button type='submit' name='submit'  class='login100-form-btn'
 value='$row[id]'>Store name:$row[name]</button>
 </div> <hr>";
}
